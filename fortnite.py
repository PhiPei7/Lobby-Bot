...
print(f'\n A free lobbybot network, created by PhiPei7. Fixed by Aspect#0002 for Patch {patch}.\n')
...
async def emote(ctx, *, content = None):
    ...
    elif content.lower() == 'crown':
        await client.party.me.clear_emote()
        await client.party.me.set_emote(asset='EID_Coronet')
        await ctx.send(f'Emote set to: Crowning Achievement')
